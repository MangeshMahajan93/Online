      ...
      <div class="row">
        ...
        <section class="col-lg-12">   
          <div class="box box-info">
            ...
            <form name ="productForm" enctype="multipart/form-data" class="form-horizontal" action="<?php echo base_url('product/editproduct/'.base64_encode($result->product_id));?>" method="post">                    
              <div class="box-body">
                    ...
                    <div class="col-sm-7">
                      <select class="form-control" id="supercategoryName" name="supercategoryName" onchange="return createcategory();">
                        <option value="">Select Super Category</option>
                          ...
                          ?>
                          <?php 
                            if($value->super_category_name == $result->super_category_name)
                            {
                          ?>
                          <option  selected="selected" value="<?php echo $value->super_category_name;?>"><?php echo $value->super_category_name;?></option>
                          <?php
                        }
                        else
                        {
                     ...
                     <div class="col-sm-7">
                      <select class="form-control" name="categoryName" id="categoryName">
                        <option value="">Select Category</option>
                          ...
                          ?>
                          <?php 
                            if($value->category_name == $result->category_name)
                            {
                          ?>
                          <option  selected="selected" value="<?php echo $value->category_name;?>"><?php echo $value->category_name;?></option>
                          <?php
                        }
                        else
                        {
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-sm-2">
                    <img height='100px' width='100px' src="<?php echo base_url('assets/uploads/').$result->product_image1?>"/>
                      </div></div>
                      <div class="form-group">
                        <label class="col-sm-2 control-label">Product Image 2</label>
                           ...
                           <span style="color:red"><?php echo form_error('image2');?></span>
                            ...
                            <div class="col-sm-2">
                    <img height='100px' width='100px' src="<?php echo base_url('assets/uploads/').$result->product_image2;?>"/>
                      </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-2 control-label">Product Image 3</label>
                           ...
                           <span style="color:red"><?php echo form_error('image3');?></span>
                            ...
                            <div class="col-sm-2">
                    <img height='100px' width='100px' src="<?php echo base_url('assets/uploads/').$result->product_image3;?>"/>
                      </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-2 control-label">Product Image 4</label>
                           ...
                           <span style="color:red"><?php echo form_error('image4');?></span>                      
                            ...
                            <div class="col-sm-2">
                    <img height='100px' width='100px' src="<?php echo base_url('assets/uploads/').$result->product_image4;?>"/>
                      </div>
                      </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                     <label class="col-sm-2 control-label">Product Price</label>
                       <div class="col-sm-7">
                           <input type="text" class="form-control" name="productRentPrice" id="productRentPrice" placeholder="Enter Product Price" value="<?php echo $result->product_rent_price;?>">
