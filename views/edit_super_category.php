      ...
      <div class="row">
        ...
        <section class="col-lg-12">   
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form name ="superCategoryForm" class="form-horizontal" action="<?php echo base_url('supercategory/editSuperCategory/'.base64_encode($result->super_category_id));?>" method="post">                    
              <div class="box-body">
                <div class="form-group">
                  <label class="col-sm-2 control-label">Super Category Name</label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control" name="supercategoryName" id="supercategoryName" placeholder="Enter Super Category Name" value="<?php echo $result->super_category_name?>">
                  ...
                  <label class="col-sm-2 control-label">Super Category Description</label>
                    <div class="col-sm-7">
                      <textarea name="supercategoryDescription" id="supercategoryDescription" rows="10" cols="80">
                        <?php echo $result->super_category_description; ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-3">
                  <button type="submit" name="superCategoryUpdate" value="UPDATE" class="btn btn-block btn-primary">Update</button> 
