      ...
      <div class="row">
        ...
        <section class="col-lg-12">   
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form name ="categoryForm" class="form-horizontal" action="<?php echo base_url('category/addcategory');?>" method="post">                    
              <div class="box-body">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">Category Name</label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control" name="categoryName" id="categoryName" placeholder="Enter Category Name" value="<?php echo @$_POST['categoryName']?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-3">
                  <button type="submit" name="categorySubmit" value="SUBMIT" class="btn btn-block btn-primary">Submit</button> 
